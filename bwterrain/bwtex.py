...
import bpy 
import importlib
from .texlib import read_binary
from .texlib import texture_utils


importlib.reload(read_binary)
importlib.reload(texture_utils)

from .texlib.read_binary import *
from .texlib.texture_utils import *
...
class Texture(object):
    ...
    def generate_dummy(self, x, y):
        ...
        img = bpy.data.images.new(self.name, x,y)
        self.mipmaps = [img]
...
class BW1Texture(Texture):
    ...
    @classmethod
    def from_path(cls, blenderimg, name, fmt, unkint2=None, unkint3=None, unkint4=None, unkint5=None, unkint6=None, unkint7=None, mipmaps=1, autogenmipmaps=False, mipmappaths = []):
    ...
    @classmethod
    def from_blender_image(cls, blenderimg, name, fmt, unkint2=None, unkint3=None, unkint4=None, unkint5=None, unkint6=None, unkint7=None, mipmaps=1, autogenmipmaps=False):
        if unkint2 is None: unkint2 = FORMATDEFAULTSBW1[fmt][0]
        if unkint3 is None: unkint3 = FORMATDEFAULTSBW1[fmt][1]
        if unkint4 is None: unkint4 = FORMATDEFAULTSBW1[fmt][2]
        if unkint5 is None: unkint5 = FORMATDEFAULTSBW1[fmt][3]
        ...
        tex.unkint6 = unkint6
        tex.unkint7 = unkint7
        img = Image.from_blender(blenderimg)
        tex.mipmaps.append(img)
